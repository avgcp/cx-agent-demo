...
- [~] 05-02 — Decision card + quick actions — built and deployed (chat v3 `657ecb18`); card invocation and payload confirmed, **rendering unverified** (Preview shows raw JSON; needs the real embed) and `cover_offer_actions` never fired. See 05-02-SUMMARY.md
...
**Built so far**: `Meridian Claim - Chat (hardened)` `a2f621e4-9faf-505a-b804-22471f022366`, deployment `d7bfbb93` (`WEB_UI`/`CHAT_ONLY`) on version `657ecb18` (chat v3). Voice app `6e01e4a5` untouched on v11 `b17c9a26`.
